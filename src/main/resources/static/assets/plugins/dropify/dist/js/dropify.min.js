    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    "default": "Nhập chuột để chọn hoặc kéo và thả tệp tin vào đây",
                    replace: "Nhấp chuột hoặc kéo và thả tệp tin thay thế",
                    remove: "Xóa",
                    error: "Có lỗi xảy ra."
                },
                error: {
                    fileSize: "Dung lượng quá lớn, tối đa là {{ value }}.",
